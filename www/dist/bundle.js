...
let inRent = {
    view: function() {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1.title", "Uthyrning pågår"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()(
                'button',
                {
