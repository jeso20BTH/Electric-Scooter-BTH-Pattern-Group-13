...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (scooterModel);


/***/ }),

/***/ "./www/js/models/utilities.js":
/*!************************************!*\
  !*** ./www/js/models/utilities.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_scooter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../models/scooter */ "./www/js/models/scooter.js");
/* harmony import */ var _models_utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../models/utilities */ "./www/js/models/utilities.js");
...
let rent = {
    view: function() {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.column.flex.between.rent-div', [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1.title", "Hyr en cykel"),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("p.text", `Scanna en QR-kod eller skriv in cykelns ID för att hyra den.`),
                ]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.rent-input-div', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("input.cycle", {
                        placeholder: 'Ange cykel ID',
                        oninput: (event) => {
                            _models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].id = event.target.value;
                            console.log(event.target.value);
                        },
                        value: _models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].id
                    }),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("button.flex.column.center.qr-btn", {onclick: ()=>{console.log("QR");}},
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.row.center',
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()(
                        "button",
                        {
                            onclick: _models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].rent
                        },
                        'Hyr'
                    )
                )
...
let inRent = {
    view: function() {
        let curScooter = _models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].currentScooter;
        let speed = curScooter.speed;
        let battery = Math.floor(curScooter.battery * 100);
        let scooterId = curScooter.id;
        let timeRented = _models_utilities__WEBPACK_IMPORTED_MODULE_2__["default"].calculateTime(_models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].rentTime);
        let batteryPercetageClass = _models_utilities__WEBPACK_IMPORTED_MODULE_2__["default"].batteryPercentage(battery);
        ...
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.flex.column.between.scooter-info", [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.row.between.allign-center', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('span', `${speed}km/h`),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.row.center.battery-div', [
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()(`div.battery-percent-div.${batteryPercetageClass}`, {
                            style: {
                                right: `${100-battery}%`
                            }
                        }),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.battery-percent-text', `${battery}%`)
                    ])
                ]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.row.center',
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.header', `Hyrd elsparkcykel ${scooterId}`)
                    ),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.row.center',
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.time-description', 'Tid uthyrd')
                    ),
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.row.center',
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('span.time', `${timeRented}`)
                    )
                ]),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.column.flex.center.button-div', [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()(
                        'button',
                        {
                    ...
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()(
                        'button',
                        {
                            onclick: _models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].unrent
                        },
                        'Lämna'
                    ),
                ])
...
let index = {
    onInit: () => {
        _models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].getAllScooters();
    },
    view: function() {
        return (!_models_scooter__WEBPACK_IMPORTED_MODULE_1__["default"].inRent) ? mithril__WEBPACK_IMPORTED_MODULE_0___default()(rent) : mithril__WEBPACK_IMPORTED_MODULE_0___default()(inRent)
    }
};
...
let layout = {
    ...
    view: function(vnode) {
        return [
            (_models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].authorized) ?
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('nav.flex.row.between.nav', [
...
let login = {
    view: () => {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('div.flex.column.center.login-div',
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('h1', 'Logga in'),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()('button.display.flex.row.center.allign-center', {
                        onclick: _models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].login
                    }, [
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('p', 'Logga in med github'),
                        mithril__WEBPACK_IMPORTED_MODULE_0___default()('i.fab.fa-github')
                    ]
                )
            )
        ]
...
let map = {
    view: () => {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('h1', 'Karta')
        ]
    }
}
...
let user = {
    view: () => {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('h1', _models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].currentUser.name),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()('p', `Krediter: ${_models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].currentUser.credits} SEK`)
        ]
    }
}
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/auth */ "./www/js/models/auth.js");
/* harmony import */ var _views_layout_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/layout.js */ "./www/js/views/layout.js");
/* harmony import */ var _views_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/index.js */ "./www/js/views/index.js");
/* harmony import */ var _views_map_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/map.js */ "./www/js/views/map.js");
/* harmony import */ var _views_login_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/login.js */ "./www/js/views/login.js");
/* harmony import */ var _views_user_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/user.js */ "./www/js/views/user.js");
...
function onDeviceReady() {
    mithril__WEBPACK_IMPORTED_MODULE_0___default().route(document.body, "/", {
        "/": {
            onmatch: function() {
                if (_models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].authorized) {
                    return _views_index_js__WEBPACK_IMPORTED_MODULE_3__["default"];
                }
                return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/login");
            },
            render: function(vnode) {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_layout_js__WEBPACK_IMPORTED_MODULE_2__["default"], vnode);
            }
        },
        "/map": {
            onmatch: function() {
                if (_models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].authorized) {
                    return _views_map_js__WEBPACK_IMPORTED_MODULE_4__["default"];
                }
                return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/login");
            },
            render: function(vnode) {
        ...
        "/user": {
            onmatch: function() {
                if (_models_auth__WEBPACK_IMPORTED_MODULE_1__["default"].authorized) {
                    return _views_user_js__WEBPACK_IMPORTED_MODULE_6__["default"];
                }
                return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/login");
            },
            render: function(vnode) {
        ...
        "/login": {
            render: function() {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_layout_js__WEBPACK_IMPORTED_MODULE_2__["default"], mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_login_js__WEBPACK_IMPORTED_MODULE_5__["default"]));
            }
        }
    });
}
